...
\begin{abstract}
	...
	\lr{SDN} وعده داده است که به صورت چشمگیری مدیریت شبکه را آسان کند و همچنین با استفاده از قابلیت برنامه نویسی شبکه، امکان پیاده سازی ایده های جدید در شبکهبه سادگی  را بوجود آورد.
\end{abstract}
\end{document}
